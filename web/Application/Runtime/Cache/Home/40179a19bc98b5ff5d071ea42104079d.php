            ...
            <div class="box_center">
              <form action="" class="jqtransform" method="post">
               ...
               <table class="form_table pt15 pb15" width="100%" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr >
                  <td class="td_right">出库人：</td>
                  <td class="">
                    <input type="text" readonly value="<?php echo ($vo["employee_name"]); ?>" class="input-text lh30" size="40">
                  </td>
                 </tr>
                <tr >
                  <td class="td_right">出库时间：</td>
                  <td class="">
                    <input type="text" readonly value="<?php echo ($vo["sale_date"]); ?>" class="input-text lh30" size="40">
                  </td>
                 </tr>
...
$(function(){
  ...
  $("#flex").flexigrid({
        url:'/index.php/Home/Sale/items/id/<?php echo ($vo["id"]); ?>',
        dataType: 'json',
        colModel : colModel ,
        sortname : "id",
        sortorder : "asc",
