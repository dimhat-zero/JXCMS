...
<!-- 增加表单 -->
  <div id="signup">
      ...
      <div id="signup-ct">
          ...
          <form action="/index.php/Home/Sale/addItem" id="itemForm">
...
function reloadFlex(){
  $.get('/index.php/Home/Sale/items',function(data){
    console.log(data);
    if(data.success){
...
function flexDel(){
  ...
  if (confirm("确定删除商品[" + names + "]?")) {
      $.get('/index.php/Home/Sale/delItem/ids/'+ids,function(){
        reloadFlex();
      });
   }
}
...
$(function(){
  ...
  $("#itemAddBtn").click(function(){
      $.ajax({
        url:'/index.php/Home/Sale/addItem',
