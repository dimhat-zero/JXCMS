...
<div class="container">
    ...
    <div id="button" class="mt10">
        <a href="/index.php/Home/Sale/add">
        ...
        <div class="box span10 oh">
            <table width="100%" border="0" cellpadding="0" cellspacing="0" class="list_table">
                ...
                <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr class="tr">
                    ...
                    <td><?php echo ($vo["sale_date"]); ?></td>
                    <td><?php echo ($vo["price"]); ?></td>
                    <td><a href="/index.php/Home/Sale/detail/id/<?php echo ($vo["id"]); ?>" class="opa">查看详情</a></td>
...
$(document).ready(function(){
    $(".btn_del").click(function(){
        if(confirm("确定删除吗？")){
            location = "/index.php/Home/Sale/del/ids/"+getCheckboxIds();
        }
    });
    //初始化分页
